Page({
  ...
  onShareAppMessage: function (res) {
    ...
    var url = '/pages/huoxing/pages/ftfx/ftfx?word=' + word 
    var title = '考考您认识以下几个繁体字'
    return {
      title: title,
      path: url,
  ...
  formSubmit:function(e){
    ...
    wx.navigateTo({
      url: "/pages/huoxing/pages/ft/ft?word=" + text
    })
  },

  //获取繁体字
  fanti: function (options) {
    var that = this
    var text = options.word
    wx.request({
      method: 'GET',
      url: 'https://japi.juhe.cn/charconvert/change.from?text=' + text + '&type=1&key=ea58b4225e0db75f6f63d5f3a6d4fba3',
      data: {},
      header: {
  ...
  save: function (e) {
    ...
    canvasCtx.setFillStyle(color);
    canvasCtx.setTextAlign('left');
    canvasCtx.fillText('不只是繁体👉', 90, 330);
    //绘制二维码
    canvasCtx.drawImage('/i/fanti.jpg', 240, 305, 60, 60);
    //绘制扫码提示文字
