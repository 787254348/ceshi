...
Page({
  onShareAppMessage: function (options) {
    ...
    if (nickName) {
      var title = nickName + '给您送来晚安祝福，请查收！'
      var url = '/pages/newheka/pages/wanan/wanan?nickName=' + nickName + '&avatarUrl=' + avatarUrl + '&v=' + vip
    } else {
      var title = '我給您送来晚安祝福，请查收！'
      var url = '/pages/newheka/pages/wanan/wanan?v=' + vip
    }
    return {
      title: title,
      desc: '电子贺卡',
