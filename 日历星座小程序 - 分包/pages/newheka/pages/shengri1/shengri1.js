...
Page({
  onShareAppMessage: function (options) {
    ...
    if (nickName) {
      var title = nickName + '给您送来生日祝福，请查收！'
      var url = '/pages/newheka/pages/shengri1/shengri1?nickName=' + nickName + '&avatarUrl=' + avatarUrl + '&v=' + vip
    } else {
      var title = '我給您送来生日祝福，请查收！'
      var url = '/pages/newheka/pages/shengri1/shengri1?v=' + vip
    }
    return {
      title: title,
      desc: '电子贺卡',
