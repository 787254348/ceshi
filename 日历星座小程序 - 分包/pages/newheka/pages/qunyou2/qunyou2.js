...
Page({
  onShareAppMessage: function (options) {
    ...
    if (nickName) {
      var title = nickName + '给您送来幸福贺卡，请查收！'
      var url = '/pages/newheka/pages/qunyou2/qunyou2?nickName=' + nickName + '&avatarUrl=' + avatarUrl + '&v=' + vip
    } else {
      var title = '我給您送来幸福贺卡，请查收！'
      var url = '/pages/newheka/pages/qunyou2/qunyou2?v=' + vip
    }
    return {
      title: title,
      desc: '电子贺卡',
