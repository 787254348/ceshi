...
Page({
  onShareAppMessage: function (options) {
    ...
    if (nickName) {
      var title = nickName + '给您送来早安祝福，请查收！'
      var url = '/pages/newheka/pages/zaoan/zaoan?nickName=' + nickName + '&avatarUrl=' + avatarUrl + '&v=' + vip
    } else {
      var title = '我給您送来早安祝福，请查收！'
      var url = '/pages/newheka/pages/zaoan/zaoan?v=' + vip
    }
    return {
      title: title,
      desc: '电子贺卡',
