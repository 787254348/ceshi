export function watermark(settings) {
  //默认设置
  var defaultSettings={
      watermark_txt:"张三&6969&20221104",
  ...
  var oTemp = document.createElement('div')
    ...
    oTemp.style.zIndex = '100000'
    oTemp.style.width = document.documentElement.clientWidth + 'px'
    oTemp.style.height = document.documentElement.clientHeight + 'px'
  ...
  for (var i = 0; i < defaultSettings.watermark_rows; i++) {
      let y1 = defaultSettings.watermark_y + (defaultSettings.watermark_y_space + defaultSettings.watermark_height) * i;
      ...
      for (var j = 0; j < defaultSettings.watermark_cols; j++) {
          ...
          if(i%2==0){
            if(j%2==0){
              y = y1
              //y = y1+defaultSettings.watermark_height/2
            }else{
              y = y1-defaultSettings.watermark_height/2
            }
            if(i%4==0){
  ...
  defaultSettings.dom.appendChild(oTemp);
}
