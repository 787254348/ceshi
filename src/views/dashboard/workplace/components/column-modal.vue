	...
	<a-modal :class="{'column-modal':!darkMode}" :width="940" v-model:visible="visible" :centered="true"  :closable="false" :footer="null">
	        ...
	        <div class="content">
				    <table class="ele-table ele-table-border ele-table-medium">
				        ...
				        <thead>
				            <tr>
                        <th><span class="border-right">序</span></th>
				                <th><span class="border-right"><em/></span></th>
				                <th width="200"><span class="border-right">列名</span></th>
				                <th><span class="border-right">显示</span></th>
                        <th><span class="border-right">加粗</span></th>
                        <th width="80"><span class="border-right">宽度</span></th>
                        <th><span class="border-right">冻结</span></th>
                        <th><span class="border-right">对齐方式</span></th>
				            </tr>
				        </thead>
				        <vue-draggable
				            tag="tbody"
				        ...
				        >
                            ...
                            <td>{{ index+1 }}</td>
                                ...
                                <span class="iconfont icon-zu40 ele-text-info demo-table-drag-handle" style="cursor: move;"></span>
				                    ...
				                    <td><a-input v-model:value="element.columnName" placeholder="" :bordered="false" style="padding: 0;"/></td>
                            <td><a-checkbox v-model:checked="element.visible"></a-checkbox></td>
                            <td><a-checkbox v-model:checked="element.bold"></a-checkbox></td>
                            <td>
                              <a-input
