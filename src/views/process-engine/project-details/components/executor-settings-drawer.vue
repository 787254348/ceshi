<template>
    ...
    >
      <template #title>
        <b>执行人<span class="iconfont icon-edit ele-text-placeholder margin-left-10"></span></b>
      </template>
      <template #extra>
      ...
      <a-tabs v-model:activeKey="activeKey">
        <a-tab-pane key="set" tab="设置执行人">
          ...
          <a-radio-group v-model:value="setData.set" name="radioGroup" @change="setRadio">
            ...
            <a-radio class="margin-top-10 width-23" value="approval">多级执行</a-radio>
          ...
          <div v-show="setData.set=='member'">
            <div class="margin-top-20"><b>选择执行人</b></div>
          ...
          <div v-show="setData.set=='approval'">
            <div class="margin-top-20"><b>执行起点</b></div>
            ...
            <div class="margin-top-20"><b>执行终点</b></div>
            ...
            <a-checkbox class="margin-top-10" v-model:checked="setData.approval.end.checked">找不到负责人时，由上级主管代执行</a-checkbox>
          </div>
          <!-- 发起人本人 -->
          <div v-show="setData.set=='oneself'">
            <div class="margin-top-20"><b>说明</b></div>
            <div class="margin-top-10"><span class="ele-text-danger">*</span>发起人本人将作为执行人。（一般用于发起人信息复核的场景）</div>
          </div>
          <!-- 发起人自选 -->
          ...
          <div v-show="setData.set!='oneself'">
            <div class="margin-top-20"><b>多人执行方式</b></div>
            <a-radio-group v-model:value="setData.mode">
              <a-radio class="margin-top-10 flex"  value="1">会签（需所有执行人同意）</a-radio>
              <a-radio class="margin-top-10 flex"  value="2">或签（一名执行人同意即可）</a-radio>
              <a-radio class="margin-top-10 flex" value="3">依次执行（按顺序依次执行）</a-radio>
            </a-radio-group>
          </div>
          <div class="margin-top-20"><b>执行意见</b></div>
...
<script setup>
  ...
  const close = () => {
    console.log(111,setData,defalutSetData)
