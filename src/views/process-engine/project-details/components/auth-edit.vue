<template>
  <a-modal :width="600" class="auth-edit-modal" v-model:visible="visible" :centered="true"  title="字段权限管理" @cancel="cancel" :maskClosable="false" :keyboard="false">
  ...
  <!-- 删除提示弹窗 -->
  <yModal ref="dltModal" title="删除提示" okText="删除" content="删除后对应用户将无法查看及操作该字段,请确认删除"  :centered="true" :closable="false"  :danger="true" @ok="dlt"></yModal>
</template>
