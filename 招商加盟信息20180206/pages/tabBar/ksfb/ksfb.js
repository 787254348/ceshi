...
Page({
  data: {
    tempFilePaths: '',
    array: ['餐饮', '教育', '服装', '美容', '保健', '机械', '其他'],
    cateIdArray: [953, 954, 703, 955, 956, 957, 958],
    index: 6,
    userInfo: {},
    storage: '',
    city: '',
  ...
  chooseimage: function () {
    ...
    wx.chooseImage({
      ...
      success: function (res) {
        ...
        wx.uploadFile({
          url: 'https://wap.goods100.com/home/zsapi/upload', //图片上传接口地址
  ...
  formSubmit: function (e) {
    ...
    if (!(/^1[234578]\d{9}$/.test(mobile))) { //验证是不是正确的11位手机号码
      wx.showModal({
        title: '提示',
    ...
    wx.request({
      url: 'https://wap.goods100.com/home/zsapi/ksfb',
      data: formData,
      header: {
      ...
      success: function (res) {
        ...
        if (res.data[1] < 3) {
          if (res.data[1] == 0) {
            var content = "感谢您使用本衣网小程序！您在本衣网（与小程序互通）的账户名为" + username + "密码是" + num + "，我们能为您提供专业的服务助力您的招商加盟:1.信息优先展示；2.招商通VIP专属标识提升信誉，促进合作；3.让商机在平台获得全网曝光。如需办理请点个人—>服务升级。     提示:上传营业执照/身份证实名认证，可提升信誉达成合作!(进入小程序点个人找到‘上传证书’)。重点：敬请保持每天查看“个人->我的消息”,有您的意向客户发询单。"
          } else {
            var content = "感谢您使用本衣网小程序！我们能为您提供专业的服务助力您的招商加盟:1.信息优先展示；2.招商通VIP专属标识提升信誉，促进合作；3.让商机在平台获得全网曝光。如需办理请请点个人—>服务升级。     提示:上传营业执照/身份证实名认证，可提升信誉达成合作!(进入小程序点个人找到‘上传证书’)。重点：敬请保持每天查看“个人->我的消息”,有您的意向客户发询单。"
          }
          ...
          wx.request({
            ...
            data: {
              touser: openid,
              template_id:  'SHgO5RQ8z8pEW1XvQ5c56M_NPxXcLfcJoe_zA06A_F0',//这个是1、申请的模板消息id，  
